...
class PsrthymeObservation {
   ...
   public:
	  ...
	  typedef boost::shared_ptr<PsrthymeObservation> Ptr;
	  PsrthymeObservation(const char* name) {
		 this->name=name;
	  } 
...
bool PsrthymeObservation::read(std::istream &in){
   std::string line;
   this->freq=0;
   this->imjd=0;
   this->fmjd=0;
